			...
			<table class="table table-striped" style="width: 1200px; height: 500px;">
				...
				<tr valign="middle">
					...
					<td><input type="text" class="form-control" name="name"
						style="width: 800px;" required="required"></td>
				</tr>
				<tr valign="middle">
					<td width="120">차종</td>
					<td><input type="text" class="form-control"
						style="width: 800px;" name="cname" required="required"></td>
				</tr>

				<tr valign="middle">
					<td width="120">차량번호</td>
					<td><input type="text" class="form-control"
						style="width: 800px;" name="cid" required="required"></td>
				</tr>
				...
				<tr valign="middle">
					<td colspan="2" align="center">
						<button type="submit" class="btn btn-outline-success btn-lg">견적등록</button>
					</td>
				</tr>
			</table>
		</form>
